...
public class StoryController {
    ...
    @PostMapping
    public ResponseEntity<StoryResponseTo> save(@Valid @RequestBody StoryRequestTo storyRequestTo) {
    ...
    @PutMapping
    public ResponseEntity<StoryResponseTo> update(@Valid @RequestBody StoryRequestTo storyRequestTo) {
